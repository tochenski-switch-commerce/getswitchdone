...
function MultiSelectSidebarField({
  field,
  existing,
  onSetValue,
}: {
  field: BoardCustomField;
  existing: { multi_value?: string[] } | undefined;
...
export default function CustomFieldInput({
  ...
  if (field.field_type === 'multiselect') {
    ...
    // Non-sidebar: original pill layout (needs its own hooks — inline is fine here since
    // sidebarMode is stable per component instance)
    return <MultiSelectPills field={field} existing={existing} onSetValue={onSetValue} />;
  }
