  ...
  return (
    ...
    >
      <style>{`
        ...
        .splash-text {
          opacity: 0;
          animation: splash-text-fade 0.7s ease-out 0.2s forwards;
        }
        .splash-flame {
          opacity: 0;
          transform-origin: 607.5px 85px;
          transform: scaleY(0) scaleX(0);
          animation: splash-flame-grow 0.8s cubic-bezier(0.34, 1.56, 0.64, 1) 0.7s forwards;
        }
      `}</style>
